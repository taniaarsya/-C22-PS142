package com.example.demoapp.ml;
...
public final class MyModel {
  ...
  private MyModel(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "My_Model.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static MyModel newInstance(@NonNull Context context) throws IOException {
    return new MyModel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static MyModel newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new MyModel(context, options);
  }
